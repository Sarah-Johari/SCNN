...
#set REQ_CYCLE [expr $MAX_KERNEL * $MAX_KERNEL * $MAX_FANOUT * $MAX_FANOUT + $BUFR]
#set spike frequency in MHz
set SPK_FREQ  0.1
#spike clock period is in ns
set SPKCLK_PERIOD 	[expr 1000.0 / $SPK_FREQ];
#mem clock period is in ns
set MEMCLK_PERIOD 	[expr {1.0 * $SPKCLK_PERIOD / $MAX_NEURONS}]; 
